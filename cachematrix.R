...
## this function is to create and store a special matrix object that can store its inverse matrix.
...
## Write a short comment describing this function
## This function is to retrieve if cached the inverse matrix for a given matrix created by calling makeCachedMatrix function above.
